...
{
    /* @var $googleAuthenticator powerbyme_GoogleAuthenticator */
    protected $googleAuthenticator;

    protected function setUp()
    {
        $this->googleAuthenticator = new powerbyme_GoogleAuthenticator();
    }
    ...
    public function testItCanBeInstantiated()
    {
        ...
        $this->assertInstanceOf('powerbyme_GoogleAuthenticator', $ga);
    }
    ...
    public function testSetCodeLength()
    {
        ...
        $this->assertInstanceOf('powerbyme_GoogleAuthenticator', $result);
    }
}
